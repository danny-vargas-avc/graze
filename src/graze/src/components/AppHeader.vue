    ...
    <div class="header-content">
      ...
      <template v-if="isHome">
        ...
        <nav class="desktop-nav" aria-label="Navigation">
          ...
          <RouterLink to="/map" class="nav-link" active-class="nav-link-active">Map</RouterLink>
          <RouterLink to="/profile" class="nav-link" active-class="nav-link-active">Settings</RouterLink>
        </nav>

        <!-- Mobile nav icons -->
        <div class="mobile-nav">
          <RouterLink to="/map" class="nav-icon-btn" aria-label="Map">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
              <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
              <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
            </svg>
          </RouterLink>
          <RouterLink to="/profile" class="nav-icon-btn" aria-label="Settings">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
